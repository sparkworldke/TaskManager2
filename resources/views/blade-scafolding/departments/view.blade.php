...
@section('content')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h3 class="">2456</h3>
                        <h6 class="card-subtitle">All Projects</h6></div>
                    <div class="col-12">
                        <div class="progress">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h3 class="">546</h3>
                        <h6 class="card-subtitle">Pending Projects</h6></div>
                    <div class="col-12">
                        <div class="progress">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h3 class="">$24561</h3>
                        <h6 class="card-subtitle">Complete Projects</h6></div>
                    <div class="col-12">
                        <div class="progress">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Projects Received</h4>
                    <h6 class="card-subtitle">Recently Assigned Projects</h6> </div>
                <!-- ============================================================== -->
                <!-- Comment widgets -->
                <!-- ============================================================== -->
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">All Ongoing Projects</h6> </div>
                <!-- ============================================================== -->
                <!-- Comment widgets -->
                <!-- ============================================================== -->
                <div class="comment-widgets m-b-20">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">All projects Delivered</h6> </div>
                <!-- ============================================================== -->
                <!-- Comment widgets -->
                <!-- ============================================================== -->
                <div class="comment-widgets m-b-20">
