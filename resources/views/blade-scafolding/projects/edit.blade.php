            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('blade-scafolding.projects.update',['id'=>$project->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" id="starttime" name="start_date"  value="{{$project->start_date }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Due Date / Time</label>
                                        <input  id="endtime" type="datetime-local"  class="form-control"  name="due_date"  value="{{$project->due_date }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="document" value="{{$project->document }}">
                                    </div>
                                </div>
