            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <!--End of Errors-->
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('blade-scafolding.employees.update',['id'=>$employee->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Skills</label>
                                        <textarea class="form-control"  name="skills">{{$employee->skills}}</textarea>
                                    </div>
                                </div>
                            </div>
