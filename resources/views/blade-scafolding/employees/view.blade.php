...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{ $employee->profile_img }}" class="img-circle" width="150" />
                        <h4 class="card-title m-t-10">{{$employee->first_name}} {{$employee->last_name}}</h4>
                        <h6 class="card-subtitle">{{$employee->department_id}}</h6>
                ...
                <div class="card-body"> <small class="text-muted">Email address </small>
                    <h6>{{$employee->email}}</h6> <small class="text-muted p-t-30 db">Phone</small>
                    <h6>{{$employee->phone_number}}</h6> <small class="text-muted p-t-30 db">Address</small>
                    <h6>Address Comes Here</h6>
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Userlog</a> </li>
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Profile Details</a> </li>
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">Profile Updates</a> </li>
                </ul>
                <!-- Tab panes -->
